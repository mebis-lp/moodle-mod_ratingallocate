...
$string['unassigned_users_will_be_assigned'] = 'Unassigned users will be assigned as good as possible in the background. Please wait some time and check the results in the allocations overview table.';
$string['unassigned_users_algorithm_already_running'] = 'Another distribution of unassigned users is already running. Please wait for it to finish.';
